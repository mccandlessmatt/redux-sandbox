...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appReducer = __webpack_require__(186);
	...
	_reactDom2.default.render(_react2.default.createElement(_app2.default, { store: store }), appNode);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MicroScheduler = __webpack_require__(178);

	var _MicroScheduler2 = _interopRequireDefault(_MicroScheduler);
	...
	var App = function App(_ref) {
		...
		return _react2.default.createElement(
			...
			{ store: store },
			_react2.default.createElement(_MicroScheduler2.default, null)
		);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _addTask = __webpack_require__(182);

	var _addTask2 = _interopRequireDefault(_addTask);

	var _taskList = __webpack_require__(183);
	...
	var _countDown = __webpack_require__(185);
	...
	var flip = function flip() {
		var timer = document.querySelector('.workflow-container');
		var list = timer.classList;

		list.toggle('flip');
	};

	var MicroScheduler = function MicroScheduler(_ref) {
		var step = _ref.step;
	...
	MicroScheduler = (0, _reactRedux.connect)()(MicroScheduler);

	exports.default = MicroScheduler;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timerControls = __webpack_require__(181);

	var _timerControls2 = _interopRequireDefault(_timerControls);
	...
	var Timer = function Timer() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(_timerControls2.default, null)
		);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapStateToProps = function mapStateToProps(state) {
		return { timeLabel: state.time.label };
	};
	Time = (0, _reactRedux.connect)(mapStateToProps)(Time);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changeTime = function changeTime(newTime) {
		return {
			type: 'CHANGE_TIME',
			time: newTime
		};
	...
	var mapStateToProps = function mapStateToProps(state) {
		return { time: state.time.value };
	};

	var TimerControls = _react2.default.createClass({
		displayName: 'TimerControls',
		render: function render() {
			var _this = this;

			return _react2.default.createElement('input', { type: 'range', min: 0, max: 8 * 60, value: this.props.time, step: 15, onChange: function onChange(event) {
					_this.props.dispatch(changeTime(event.target.value));
				} });
		}
	});

	TimerControls = (0, _reactRedux.connect)(mapStateToProps)(TimerControls);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var generateRGB = function generateRGB() {
	...
	var addTask = function addTask(text, total) {
		return {
			type: 'ADD_TASK',
			id: total,
			name: text,
	...
	var AddTask = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('input', { type: 'text', ref: 'taskInput', placeholder: 'What do you need to do?', onKeyUp: this.checkEnter })
			);
		}
	});

	var mapStateToProps = function mapStateToProps(state) {
		return { numTasks: state.taskList.tasks.length };
	};

	AddTask = (0, _reactRedux.connect)(mapStateToProps)(AddTask);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateTask = function updateTask(id, update) {
		return {
			type: 'UPDATE_TASK',
			id: id,
			update: update
	...
	var list = function list(task, duration, dispatch) {
		return _react2.default.createElement(
			'tr',
			{ key: task.id },
			_react2.default.createElement(
				'td',
				null,
				_react2.default.createElement('div', { className: 'color', style: { backgroundColor: task.color } }),
				task.name
			),
			_react2.default.createElement(
				'td',
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ onClick: function onClick() {
							return dispatch({ type: 'EDIT_TASK', id: task.id });
						} },
					'edit'
				)
			),
			_react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ onClick: function onClick() {
							return dispatch({ type: 'REMOVE_TASK', id: task.id });
						} },
					'x'
				)
			)
	...
	var edit = function edit(task, duration, dispatch) {
		return _react2.default.createElement(
			'tr',
			{ key: task.id },
			_react2.default.createElement(
				...
				null,
				_react2.default.createElement('div', { className: 'color', style: { backgroundColor: task.color } }),
				_react2.default.createElement('input', { type: 'text', value: task.name, onChange: function onChange(e) {
						return dispatch(updateTask(task.id, { name: e.target.value }));
					} })
			),
			_react2.default.createElement(
				'td',
				null,
				_react2.default.createElement('input', { type: 'text', value: task.duration !== undefined ? task.duration : duration, onChange: function onChange(e) {
						return dispatch(updateTask(task.id, { duration: e.target.value }));
					} }),
				'%'
			),
			_react2.default.createElement(
				...
				_react2.default.createElement(
					'button',
					{ onClick: function onClick() {
							return dispatch({ type: 'COMPLETE_EDIT_TASK', id: task.id });
						} },
					'done'
				)
			),
	...
	var row = function row(task, duration, dispatch) {
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.props.tasks.map(function (t) {
							return row(t, _this.props.duration, _this.props.dispatch);
						})
					)
				)
			);
	...
	var mapStateToProps = function mapStateToProps(state) {
		return { tasks: state.taskList.tasks, duration: state.taskList.defaultDuration };
	};

	TaskList = (0, _reactRedux.connect)(mapStateToProps)(TaskList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var taskStyles = function taskStyles(_ref) {
		var task = _ref.task;
	...
	var mapTasks = function mapTasks(_ref2) {
		var tasks = _ref2.tasks;
		var duration = _ref2.duration;
		return tasks.map(function (task) {
			return _react2.default.createElement('li', { style: taskStyles({ task: task, duration: duration }), key: task.id });
		});
	};

	var drawCountDown = function drawCountDown(arc, duration) {
		var _this = this;

		var CIRCLE = 2 * Math.PI;
		var interval = CIRCLE * (duration / 100);
		this.context.clearRect(0, 0, 200, 200);

		this.props.tasks.reduce(function (prev, current) {
			var end = prev + (current.duration !== undefined ? CIRCLE * (current.duration / 100) : interval);
			_this.context.beginPath();
			_this.context.strokeStyle = current.color;
			_this.context.arc(100, 100, 75, prev, end);
			_this.context.lineWidth = 25;
	...
	var TimeLine = _react2.default.createClass({
		...
		startTimer: function startTimer() {
			...
			times = this.props.tasks.map(function (current, index, tasks) {
				return Math.PI * 2 / tasks.length * (index + 1);
			});
		},
		countDown: function countDown(timestamp) {
	   	...
	   	new Notification('moving onto',{
	   		body:`moving onto ${this.props.tasks[currentTask].name}`,
	   ...
	   */
			...
			if (position <= Math.PI * 2) {
				drawCountDown.call(this, position);
				window.requestAnimationFrame(this.countDown);
			} else {
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('canvas', { height: '200px', width: '200px', ref: 'timeline' }),
				_react2.default.createElement(
					'button',
	...
	var mapStateToProps = function mapStateToProps(state) {
		return { tasks: state.taskList.tasks, duration: state.taskList.defaultDuration, time: .25 };
	};
	TimeLine = (0, _reactRedux.connect)(mapStateToProps)(TimeLine);
...
/***/ function(module, exports, __webpack_require__) {
	...
	countDown = (0, _reactRedux.connect)(stateToProps)(countDown);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _taskListReducer = __webpack_require__(187);

	var _taskListReducer2 = _interopRequireDefault(_taskListReducer);

	var _timeReducer = __webpack_require__(189);
	...
	var reducer = (0, _redux.combineReducers)({
		taskList: _taskListReducer2.default,
		time: _timeReducer2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _taskReducer = __webpack_require__(188);
	...
	var calculateDuration = function calculateDuration(tasks) {
		var numDefault = tasks.filter(function (t) {
			return t.duration === undefined;
		}).length;
		var explicitTotal = tasks.reduce(function (previous, current) {
			return previous + parseInt(current.duration || 0, 10);
		}, 0);
		var maxDuration = 100 - explicitTotal;

		return maxDuration / numDefault;
	};

	var taskListReducer = function taskListReducer() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { tasks: [], defaultDuration: 100 } : arguments[0];
		var action = arguments[1];

		var tasks = undefined;
		var defaultDuration = undefined;

		switch (action.type) {
			case 'ADD_TASK':

				tasks = [].concat(_toConsumableArray(state.tasks), [(0, _taskReducer2.default)(null, action)]);
			...
			case 'COMPLETE_EDIT_TASK':
				tasks = state.tasks.map(function (t) {
					return (0, _taskReducer2.default)(t, action);
				});
				defaultDuration = calculateDuration(tasks);
	...
	exports.default = taskListReducer;
	...
	var taskReducer = function taskReducer() {
		...
		switch (action.type) {
			...
			case 'UPDATE_TASK':
				...
				var newTask = _extends({}, state, action.update);
...
/***/ function(module, exports) {
	...
	var timeReducer = function timeReducer() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? { value: 0, label: '0h 0m' } : arguments[0];
		var action = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];
